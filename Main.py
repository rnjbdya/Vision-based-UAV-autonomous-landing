...
if __name__ == "__main__":
    ...
    parser.add_argument('--source', default='rs', help='Either Intel Realsense: rs; or Raspberry pi-cam2: pi')0
    parser.add_argument('--connect', default='/dev/ttyTHS0', help="Target vehicle connection string.")
    ...
    cap = VideoCapture(capture_width, capture_height, detection_width, detection_height,
                       frame_rate, flip_method, source)

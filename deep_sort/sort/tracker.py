...
class Tracker:
    ...
    def _match(self, detections):
        """Based on the appearance information and the Mahalanobis distance, calculate the cost matrix of the tracks
        predicted by the Kalman filter and the detections detected at the current moment"""
        def gated_metric(tracks, dets, track_indices, detection_indices):
            ...
            """Based on the Mahalanobis distance, filter out some inappropriate items in the cost matrix 
